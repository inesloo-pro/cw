import svgPaths from "./svg-21x7hwr478";
...
function Document() {
  return (
    <div className="bg-white content-stretch flex gap-[12px] items-center max-w-[436px] p-[12px] relative rounded-[6px] shrink-0 w-[318px]" data-name="Document">
...
function Asset() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Asset">
      <Document />
    </div>
  );
}
...
function Right1() {
  return (
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="Right">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Icon/Interface/pen-light">
        <div className="absolute inset-[0_0.12%_0.12%_0]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9811 15.9811">
            <path d={svgPaths.p1e92d700} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Icon/Interface/flag-light">
        <div className="absolute inset-[0_6.25%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 16">
            <path d={svgPaths.p2e9ed080} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Icon/Interface/clone-light">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
          <path d={svgPaths.p264d5100} fill="var(--fill-0, white)" id="Vector" />
        </svg>
      </div>
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Icon/Interface/arrow-turn-down-right-light">
        <div className="absolute inset-[11.25%_0.01%_10.63%_0]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.9984 12.4984">
            <path d={svgPaths.p14a8ee00} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Icon/Interface/trash-light">
        <div className="absolute inset-[0_6.25%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 16">
            <path d={svgPaths.pba11780} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
function Action3() {
  return (
    <div className="relative shrink-0 w-full" data-name="Action">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pr-[2px] relative w-full">
          <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Icon/Interface/circle-light">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
              <path d={svgPaths.p37cd870} fill="var(--fill-0, white)" id="Vector" />
            </svg>
          </div>
          <Right1 />
        </div>
...
function MediaOverlay() {
  return (
    <div className="absolute bg-[rgba(60,60,59,0.8)] content-stretch flex flex-col h-[240px] items-center left-[8px] p-[12px] rounded-[2px] top-[8px] w-[302px]" data-name="Media Overlay">
      <Action3 />
    </div>
  );
}
...
function Asset1() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full" data-name="Asset">
...
export default function Body() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center pt-[40px] px-[120px] relative size-full" data-name="Body">
      ...
      <div className="h-0 relative shrink-0 w-full" data-name="Divider">
        <div className="absolute bottom-full left-0 right-0 top-0" data-name="Divider">
          <div className="absolute inset-[-0.5px_0]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1681 1">
              <path d="M0.5 0.5H1680.5" id="Divider" stroke="var(--stroke-0, #E4E4E4)" strokeLinecap="round" />
            </svg>
          </div>
        </div>
      </div>
